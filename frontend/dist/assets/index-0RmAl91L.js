    ...
    case 19:
      ...
      if (null === g) if (d) Ej(f2, false);
        ...
        if (!d) if (a = Mh(g), null !== a) {
          if (b.flags |= 128, d = true, c = a.updateQueue, null !== c && (b.updateQueue = c, b.flags |= 4), Ej(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g.alternate && !I) return S(b), null;
  ...
  for (var d = 0 !== (a.mode & 1); null !== V; ) {
    ...
    if (22 === e.tag && d) {
      ...
      if (!g) {
        ...
        var l2 = U;
        Kj = g;
        if ((U = k2) && !l2) for (V = e; null !== V; ) g = V, k2 = g.child, 22 === g.tag && null !== g.memoizedState ? kk(e) : null !== k2 ? (k2.return = g, V = k2) : kk(e);
...
const tableVideo = "/assets/table-_w3LEANw.mp4";
reactExports.useEffect(() => {
  const v2 = videoRef.current;
  if (!v2) return;
  /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef, className: "table-video", autoPlay: true, loop: true, muted: true, playsInline: true, controls: true });
  const start = async () => {
    try {
      await v2.play();
    } catch (e) {
...
function flipToOwner(grid, ni2, newOwner) {
  const t2 = grid[ni2];
  if (!t2) return false;
  if (t2.owner === newOwner) return false;
  grid[ni2] = {
    ...t2,
    owner: newOwner,
    captureKey: (t2.captureKey || 0) + 1
    // подпрыгивание
  };
  return true;
}
function resolvePlacementFlips(placedIdx, grid, rules) {
  ...
  const infos = neighborsOf(placedIdx).map(({ ni: ni2, a, b }) => {
    const target = grid[ni2];
    if (!target) return null;
    const p2 = placed.values[a];
    const q2 = target.values[b];
    return { ni: ni2, placedSide: p2, targetSide: q2, sum: p2 + q2 };
  }).filter(Boolean);
  ...
  const specialType = sameTriggered && plusTriggered ? "both" : sameTriggered ? "same" : plusTriggered ? "plus" : "";
  const flipped = [];
  for (const ni2 of toFlip) {
    if (flipToOwner(grid, ni2, placed.owner)) flipped.push(ni2);
  }
...
function captureByPowerFrom(idx, grid) {
  ...
  if (!src) return [];
  const flipped = [];
  for (const { ni: ni2, a, b } of neighborsOf(idx)) {
    const t2 = grid[ni2];
    if (!t2) continue;
    if (t2.owner === src.owner) continue;
    if (src.values[a] > t2.values[b]) {
      if (flipToOwner(grid, ni2, src.owner)) flipped.push(ni2);
    }
  }
  return flipped;
}
function resolveCombo(queue, grid, rules) {
  ...
  while (q2.length) {
    ...
    if (more.length) q2.push(...more);
  }
}
function Game({ onExit }) {
  const videoRef2 = reactExports.useRef(null);
  const aiGuard = reactExports.useRef({ handled: false });
  const makeHands = () => ({
    player: Array.from({ length: 5 }, (_, i) => genCard("player", `p${i}`)),
    enemy: Array.from({ length: 5 }, (_, i) => genCard("enemy", `e${i}`))
  });
  const [{ player, enemy }, setHands] = reactExports.useState(makeHands);
  const [board, setBoard] = reactExports.useState(Array(9).fill(null));
  const [selected, setSelected] = reactExports.useState(null);
  const [turn, setTurn] = reactExports.useState(() => randomFirstTurn());
  ...
  const placeCard = (i) => {
    ...
    const { flipped, specialType } = resolvePlacementFlips(i, next);
    if (specialType) {
      next[i] = { ...next[i], specialType, specialKey: (next[i].specialKey || 0) + 1 };
    }
    resolveCombo(flipped, next);
    setBoard(next);
  ...
  reactExports.useEffect(() => {
    ...
    const empty = board.map((c, idx) => c === null ? idx : null).filter((v2) => v2 !== null);
    ...
    const { flipped, specialType } = resolvePlacementFlips(cell, next);
    if (specialType) {
  ...
  reactExports.useEffect(() => {
    ...
    const p2 = board.filter((c) => c.owner === "player").length;
    const e = board.filter((c) => c.owner === "enemy").length;
    setWinner(p2 > e ? "player" : e > p2 ? "enemy" : "draw");
    setGameOver(true);
  }, [board]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `game-root ${gameOver && winner === "enemy" ? "defeat" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "table-bg", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx("video", { ref: videoRef2, className: "table-video", autoPlay: true, loop: true, muted: true, playsInline: true, preload: "auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("source", { src: tableVideo, type: "video/mp4" }) }) }),
    gameOver && winner === "enemy" && /* @__PURE__ */ jsxRuntimeExports.jsx(DiceRain, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-ui", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "exit", onClick: onExit, children: "← Меню" }),
      gameOver && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "game-over", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-over-box", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { children: [
          winner === "player" && "Победа",
          winner === "enemy" && "Поражение",
          winner === "draw" && "Ничья"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "game-over-buttons", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: reset, children: "Заново" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onExit, children: "Меню" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hand top", children: enemy.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hand-slot", style: { zIndex: i }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { card: c, disabled: true }) }, c.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "scorebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "score red", children: [
          "🟥 ",
          score.red
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `turn-pill ${turn}`, "aria-label": "turn", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "turn-dot" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "score blue", children: [
          score.blue,
          " 🟦"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "board", children: board.map((cell, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: `cell ${selected && !cell ? "highlight" : ""}`,
          onClick: () => placeCard(i),
          children: cell && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { card: cell })
        },
        i
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hand bottom", children: player.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hand-slot", style: { zIndex: i }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Card,
        {
          card: c,
          selected: (selected == null ? void 0 : selected.id) === c.id,
...
function Card({ card, onClick, selected, disabled }) {
  const [placedAnim, setPlacedAnim] = reactExports.useState(false);
  const [capturedAnim, setCapturedAnim] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (!(card == null ? void 0 : card.placeKey)) return;
    setPlacedAnim(true);
    const t2 = setTimeout(() => setPlacedAnim(false), 380);
    return () => clearTimeout(t2);
  }, [card == null ? void 0 : card.placeKey]);
  reactExports.useEffect(() => {
    if (!(card == null ? void 0 : card.captureKey)) return;
    setCapturedAnim(true);
    const t2 = setTimeout(() => setCapturedAnim(false), 360);
    return () => clearTimeout(t2);
  }, [card == null ? void 0 : card.captureKey]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "card-anim", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { className: "card-art-img", src: card.imageUrl, alt: "", draggable: "false" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tt-badge" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tt-num top", children: card.values.top }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tt-num left", children: card.values.left }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tt-num right", children: card.values.right }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tt-num bottom", children: card.values.bottom })
      ] })
    }
  );
}
function DiceRain() {
  const dice = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dice-rain", "aria-hidden": "true", children: dice.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      className: "die",
      style: {
...
function App() {
  const [screen, setScreen] = reactExports.useState("menu");
  if (screen === "game") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Game, { onExit: () => setScreen("menu") });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Card Clash" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setScreen("game"), children: "▶ Играть" })
  ] });
}
