...
export default function LockEscrowModal({ open, onClose, onReady, me, playerDeck, matchId: existingMatchId }) {
    ...
    var handleLock = useCallback(async function () {
        ...
        try {
            ...
            if (missing.length > 0) {
                throw new Error(
                    "Эти карты сейчас не на твоём кошельке — скорее всего они уже в эскроу из прошлого матча. " +
                    "Открой раздел «Колода», нажми «Обновить» и пересобери колоду из имеющихся карт, затем лочь снова. " +
